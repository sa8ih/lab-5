...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  firstSum = firstSum[0];
  var finalSum = sum(firstSum,c);
  finalSum = finalSum[0];
  var firstProduct = multiply(a,b);
  firstProduct = firstProduct[0];
  var finalProduct = multiply(firstProduct,c);
...
function sumArray(testArray){ //eslint-disable-line
  ...
  firstSum = firstSum[0];
  var finalSum = sum(firstSum, testArray[2]);
  finalSum = finalSum[0];
  return [finalSum, testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + finalSum + ' is their sum.'];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  firstProduct = firstProduct[0];
  var finalProduct = multiply(firstProduct, testArray[2]);
  finalProduct = finalProduct[0];
  return [finalProduct, 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + finalProduct + '.'];
}
